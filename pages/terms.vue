<template>
  <section class="px-8 md:px-8">
    ...
    <p>Welcome to Contentre!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Contentre Inc's Website, located at https://contentre.io.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Contentre if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing Contentre, you agreed to use
      cookies in agreement with the Contentre Inc's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Contentre Inc and/or its licensors own the
      intellectual property rights for all material on Contentre. All
      intellectual property rights are reserved. You may access this from
      Contentre for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Contentre</li>
      <li>Sell, rent or sub-license material from Contentre</li>
      <li>Reproduce, duplicate or copy material from Contentre</li>
      <li>Redistribute content from Contentre</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Contentre Inc
      ...
      Contentre Inc,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Contentre Inc shall not be liable for the
    ...
    <p>
      Contentre Inc reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Contentre Inc a non-exclusive license to use, reproduce,
    ...
    <p>
      ...
      hyperlink compensates the absence of Contentre Inc; and (d) the link is in
    ...
    <p>
      ...
      e-mail to Contentre Inc. Please include your name, your organization name,
    ...
    <p>
      No use of Contentre Inc's logo or other artwork will be allowed for

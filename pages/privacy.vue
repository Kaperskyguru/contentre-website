<template>
  <section class="px-8 md:px-8">
    <h1>Privacy Policy for Contentre Inc</h1>

    <p>
      At Contentre, accessible from https://contentre.io, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Contentre
      and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in Contentre. This policy is not applicable to any
    ...
    <p>
      Contentre follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Contentre uses 'cookies'. These cookies are used
    ...
    <p>
      ...
      <a
        ...
        >the Cookies article on TermsFeed website</a
      >.
    </p>
    ...
    <P
      ...
      advertising partners of Contentre.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Contentre, which are sent directly
    ...
    <p>
      Note that Contentre has no access to or control over these cookies that
    ...
    <p>
      Contentre's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Contentre does not knowingly collect any Personal Identifiable Information
